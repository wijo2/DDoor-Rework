...
namespace rework
{
    ...
    public class Rework : BaseUnityPlugin
    {
        ...
        [HarmonyPostfix]
        public static void hopSpikeCheck_post(bool __result, AI_Slime __instance, ref int ___hopSpikeCounter)
        {
            ...
            projectileSlime.gameObject.GetComponent<DamageableCharacter>().bloodVolumeSpawnOffset.x = 0.1f;
